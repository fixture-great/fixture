...
public interface CaracteristicaFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>Pontode Variacao</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Pontode Variacao</em>'.
   * @generated
   */
  ...
  /**
   * Returns a new object of class '<em>Entidadede Contexto</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Entidadede Contexto</em>'.
   * @generated
   */
  EntidadedeContexto createEntidadedeContexto();

  /**
   * Returns a new object of class '<em>Informacaode Contexto</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Informacaode Contexto</em>'.
   * @generated
   */
  InformacaodeContexto createInformacaodeContexto();

  /**
   * Returns a new object of class '<em>Elementode Produto</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Elementode Produto</em>'.
   * @generated
   */
