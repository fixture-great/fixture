...
public class InformacaodeContextoImpl extends ElementoImpl implements InformacaodeContexto
{
  ...
  {
    return CaracteristicaPackage.Literals.INFORMACAODE_CONTEXTO;
  }
  ...
  public void setOrigem(Origem newOrigem)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CaracteristicaPackage.INFORMACAODE_CONTEXTO__ORIGEM, oldOrigem, origem));
  }
  ...
  public void setValidade(Validade newValidade)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CaracteristicaPackage.INFORMACAODE_CONTEXTO__VALIDADE, oldValidade, validade));
  }
  ...
  public void setQualidade(Qualidade newQualidade)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CaracteristicaPackage.INFORMACAODE_CONTEXTO__QUALIDADE, oldQualidade, qualidade));
  }
  ...
  public void setTipoValor(TipoValor newTipoValor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CaracteristicaPackage.INFORMACAODE_CONTEXTO__TIPO_VALOR, oldTipoValor, tipoValor));
  }
  ...
  public void setValor(String newValor)
  {
    ...
    valor = newValor;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CaracteristicaPackage.INFORMACAODE_CONTEXTO__VALOR, oldValor, valor));
  }
  ...
  public EntidadedeContexto getElementoPai()
  {
    if (elementoPai != null && elementoPai.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, CaracteristicaPackage.INFORMACAODE_CONTEXTO__ELEMENTO_PAI, oldElementoPai, elementoPai));
      }
    }
    return elementoPai;
  }
  ...
  public NotificationChain basicSetElementoPai(EntidadedeContexto newElementoPai, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CaracteristicaPackage.INFORMACAODE_CONTEXTO__ELEMENTO_PAI, oldElementoPai, newElementoPai);
  ...
  public void setElementoPai(EntidadedeContexto newElementoPai)
  {
    if (newElementoPai != elementoPai)
    {
      ...
      if (elementoPai != null)
        msgs = ((InternalEObject)elementoPai).eInverseRemove(this, CaracteristicaPackage.ENTIDADEDE_CONTEXTO__INFORMACOESDE_CONTEXTO, EntidadedeContexto.class, msgs);
      if (newElementoPai != null)
        msgs = ((InternalEObject)newElementoPai).eInverseAdd(this, CaracteristicaPackage.ENTIDADEDE_CONTEXTO__INFORMACOESDE_CONTEXTO, EntidadedeContexto.class, msgs);
      msgs = basicSetElementoPai(newElementoPai, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CaracteristicaPackage.INFORMACAODE_CONTEXTO__ELEMENTO_PAI, newElementoPai, newElementoPai));
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CaracteristicaPackage.INFORMACAODE_CONTEXTO__ELEMENTO_PAI:
        if (elementoPai != null)
          msgs = ((InternalEObject)elementoPai).eInverseRemove(this, CaracteristicaPackage.ENTIDADEDE_CONTEXTO__INFORMACOESDE_CONTEXTO, EntidadedeContexto.class, msgs);
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CaracteristicaPackage.INFORMACAODE_CONTEXTO__ORIGEM:
        return getOrigem();
      case CaracteristicaPackage.INFORMACAODE_CONTEXTO__VALIDADE:
        return getValidade();
      case CaracteristicaPackage.INFORMACAODE_CONTEXTO__QUALIDADE:
        return getQualidade();
      case CaracteristicaPackage.INFORMACAODE_CONTEXTO__TIPO_VALOR:
        return getTipoValor();
      case CaracteristicaPackage.INFORMACAODE_CONTEXTO__VALOR:
        return getValor();
      case CaracteristicaPackage.INFORMACAODE_CONTEXTO__ELEMENTO_PAI:
