...
public class RaizDeContextoImpl extends ElementoImpl implements RaizDeContexto
{
  ...
  public EList<EntidadedeContexto> getEntidadesDeContexto()
  {
    ...
    {
      entidadesDeContexto = new EObjectWithInverseResolvingEList<EntidadedeContexto>(EntidadedeContexto.class, this, CaracteristicaPackage.RAIZ_DE_CONTEXTO__ENTIDADES_DE_CONTEXTO, CaracteristicaPackage.ENTIDADEDE_CONTEXTO__RAIZ);
    }
