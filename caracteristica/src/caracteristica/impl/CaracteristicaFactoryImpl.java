...
public class CaracteristicaFactoryImpl extends EFactoryImpl implements CaracteristicaFactory
{
  ...
  public static CaracteristicaFactory init()
  {
    try
    {
      CaracteristicaFactory theCaracteristicaFactory = (CaracteristicaFactory)EPackage.Registry.INSTANCE.getEFactory("caracteristica"); 
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case CaracteristicaPackage.PONTODE_VARIACAO: return createPontodeVariacao();
      ...
      case CaracteristicaPackage.ENTIDADEDE_CONTEXTO: return createEntidadedeContexto();
      case CaracteristicaPackage.INFORMACAODE_CONTEXTO: return createInformacaodeContexto();
      case CaracteristicaPackage.ELEMENTODE_PRODUTO: return createElementodeProduto();
