 ...
 * <ul>
 *   <li>{@link caracteristica.impl.LPSImpl#getPontosdeVariacao <em>Pontosde Variacao</em>}</li>
 ...
 *   <li>{@link caracteristica.impl.LPSImpl#getElementosdeProduto <em>Elementosde Produto</em>}</li>
...
{
  /**
   * The cached value of the '{@link #getPontosdeVariacao() <em>Pontosde Variacao</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * The cached value of the '{@link #getElementosdeProduto() <em>Elementosde Produto</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  public EList<PontodeVariacao> getPontosdeVariacao()
  {
    ...
    {
      pontosdeVariacao = new EObjectContainmentEList<PontodeVariacao>(PontodeVariacao.class, this, CaracteristicaPackage.LPS__PONTOSDE_VARIACAO);
    }
  ...
  public EList<ElementodeProduto> getElementosdeProduto()
  {
    ...
    {
      elementosdeProduto = new EObjectContainmentEList<ElementodeProduto>(ElementodeProduto.class, this, CaracteristicaPackage.LPS__ELEMENTOSDE_PRODUTO);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CaracteristicaPackage.LPS__PONTOSDE_VARIACAO:
      ...
      case CaracteristicaPackage.LPS__ELEMENTOSDE_PRODUTO:
