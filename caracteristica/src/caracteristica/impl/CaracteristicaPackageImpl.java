...
public class CaracteristicaPackageImpl extends EPackageImpl implements CaracteristicaPackage
{
  ...
  public void createPackageContents()
  {
    ...
    createEReference(lpsEClass, LPS__PONTOSDE_VARIACAO);
    ...
    createEReference(lpsEClass, LPS__ELEMENTOSDE_PRODUTO);
    ...
    pontodeVariacaoEClass = createEClass(PONTODE_VARIACAO);
    ...
    entidadedeContextoEClass = createEClass(ENTIDADEDE_CONTEXTO);
    createEReference(entidadedeContextoEClass, ENTIDADEDE_CONTEXTO__RAIZ);
    createEReference(entidadedeContextoEClass, ENTIDADEDE_CONTEXTO__INFORMACOESDE_CONTEXTO);

    informacaodeContextoEClass = createEClass(INFORMACAODE_CONTEXTO);
    createEAttribute(informacaodeContextoEClass, INFORMACAODE_CONTEXTO__ORIGEM);
    createEAttribute(informacaodeContextoEClass, INFORMACAODE_CONTEXTO__VALIDADE);
    createEAttribute(informacaodeContextoEClass, INFORMACAODE_CONTEXTO__QUALIDADE);
    createEAttribute(informacaodeContextoEClass, INFORMACAODE_CONTEXTO__TIPO_VALOR);
    createEAttribute(informacaodeContextoEClass, INFORMACAODE_CONTEXTO__VALOR);
    createEReference(informacaodeContextoEClass, INFORMACAODE_CONTEXTO__ELEMENTO_PAI);

    elementodeProdutoEClass = createEClass(ELEMENTODE_PRODUTO);
    createEAttribute(elementodeProdutoEClass, ELEMENTODE_PRODUTO__NOME);
    createEReference(elementodeProdutoEClass, ELEMENTODE_PRODUTO__ELEMENTO_ORIGINAL);
    ...
    createEReference(eventoRelacionalEClass, EVENTO_RELACIONAL__VARIAVELDE_CONTEXTO);
